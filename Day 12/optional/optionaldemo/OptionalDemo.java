...
public class OptionalDemo {
	...
	public Integer sum(Optional<Integer> a, Optional<Integer> b) {
		...
		// Optional.orElse - retunn the value if present otherwise returns the default
		// passes
		Integer value1 = a.orElse(new Integer(0));

		// Optional.get - get the value and value should be present
	...
	public static void main(String ar[]) {
		OptionalDemo s = new OptionalDemo();
